...
const Footer = () => {
  return (
    <footer className="relative bg-ct-footer pt-32 pb-8 mt-24">
      {/* Floating CTA Card — narrower and centered with shadow on top */}
      <div className="absolute left-1/2 -translate-x-1/2 -top-16 w-[92%] max-w-4xl px-4">
        <div className="bg-background rounded-3xl shadow-[0_-12px_40px_-10px_hsl(var(--foreground)/0.15),0_20px_40px_-10px_hsl(var(--foreground)/0.15)] px-8 md:px-10 py-7 md:py-8 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
